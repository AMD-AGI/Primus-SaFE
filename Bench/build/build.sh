...
#   --te-image <image>     Pre-built TE source image (default: rocm/primus:v26.1)
...
TE_BASE_IMAGE="docker.io/rocm/primus:v26.1"
CUSTOM_TAG=""
NO_CACHE=""
DO_PUSH=false
DRY_RUN=false
...
while [[ $# -gt 0 ]]; do
    case "$1" in
        ...
        --te-image) TE_BASE_IMAGE="$2"; shift 2 ;;
...
BUILD_CMD=(
    ...
    --build-arg TE_BASE_IMAGE="${TE_BASE_IMAGE}"
    --network=host
    --load
    ${NO_CACHE}
    -t "${IMAGE_TAG}"
