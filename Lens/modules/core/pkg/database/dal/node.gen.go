...
func newNode(db *gorm.DB, opts ...gen.DOOption) node {
	...
	_node.Address = field.NewString(tableName, "address")
	_node.GpuName = field.NewString(tableName, "gpu_name")
	_node.GpuAllocation = field.NewInt32(tableName, "gpu_allocation")
	_node.GpuCount = field.NewInt32(tableName, "gpu_count")
	_node.GpuUtilization = field.NewFloat64(tableName, "gpu_utilization")
	...
	_node.CPU = field.NewString(tableName, "cpu")
	_node.CPUCount = field.NewInt32(tableName, "cpu_count")
	_node.Memory = field.NewString(tableName, "memory")
	_node.K8sVersion = field.NewString(tableName, "k8s_version")
	_node.K8sStatus = field.NewString(tableName, "k8s_status")
	_node.KubeletVersion = field.NewString(tableName, "kubelet_version")
...
type node struct {
	...
	GpuName           field.String
	GpuAllocation     field.Int32
	GpuCount          field.Int32
	...
	K8sStatus         field.String
	KubeletVersion    field.String
...
func (n *node) updateTableName(table string) *node {
	...
	n.GpuName = field.NewString(table, "gpu_name")
	n.GpuAllocation = field.NewInt32(table, "gpu_allocation")
	n.GpuCount = field.NewInt32(table, "gpu_count")
	n.GpuUtilization = field.NewFloat64(table, "gpu_utilization")
	n.Status = field.NewString(table, "status")
	n.CreatedAt = field.NewTime(table, "created_at")
	n.UpdatedAt = field.NewTime(table, "updated_at")
	n.CPU = field.NewString(table, "cpu")
	n.CPUCount = field.NewInt32(table, "cpu_count")
	n.Memory = field.NewString(table, "memory")
	n.K8sVersion = field.NewString(table, "k8s_version")
	n.K8sStatus = field.NewString(table, "k8s_status")
	n.KubeletVersion = field.NewString(table, "kubelet_version")
...
func (n *node) fillFieldMap() {
	...
	n.fieldMap["gpu_name"] = n.GpuName
	n.fieldMap["gpu_allocation"] = n.GpuAllocation
	n.fieldMap["gpu_count"] = n.GpuCount
	n.fieldMap["gpu_utilization"] = n.GpuUtilization
	n.fieldMap["status"] = n.Status
	n.fieldMap["created_at"] = n.CreatedAt
	n.fieldMap["updated_at"] = n.UpdatedAt
	n.fieldMap["cpu"] = n.CPU
	n.fieldMap["cpu_count"] = n.CPUCount
	n.fieldMap["memory"] = n.Memory
	n.fieldMap["k8s_version"] = n.K8sVersion
	n.fieldMap["k8s_status"] = n.K8sStatus
	n.fieldMap["kubelet_version"] = n.KubeletVersion
