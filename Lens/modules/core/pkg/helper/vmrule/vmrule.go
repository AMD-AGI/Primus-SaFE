...
func (m *VMRuleManager) CreateOrUpdateVMRule(ctx context.Context, rule *model.MetricAlertRules) error {
...
func (m *VMRuleManager) GetVMRuleStatus(ctx context.Context, name string) (*coremodel.VMRuleStatus, error) {
	...
	if err != nil || !found {
		return &coremodel.VMRuleStatus{Phase: "Unknown"}, nil
	}
	...
	var vmruleStatus coremodel.VMRuleStatus
