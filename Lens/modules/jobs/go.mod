module github.com/AMD-AGI/Primus-SaFE/Lens/modules/jobs
...
require (
	...
	github.com/VictoriaMetrics/VictoriaMetrics v1.108.1 // indirect
	...
	k8s.io/kubelet v0.33.0-alpha.3 // indirect
