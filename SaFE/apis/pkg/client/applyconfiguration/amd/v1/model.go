...
func (b *ModelApplyConfiguration) WithCreationTimestamp(value apismetav1.Time) *ModelApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *ModelApplyConfiguration) WithDeletionTimestamp(value apismetav1.Time) *ModelApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *ModelApplyConfiguration) WithOwnerReferences(values ...*metav1.OwnerReferenceApplyConfiguration) *ModelApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
	for i := range values {
		if values[i] == nil {
