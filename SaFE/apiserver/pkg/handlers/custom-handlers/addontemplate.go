...
func cvtToAddonTemplateResponseItem(addonTemplate *v1.AddonTemplate) types.AddonTemplateResponseItem {
	result := types.AddonTemplateResponseItem{
...
func cvtToGetAddonTemplateResponse(addonTemplate *v1.AddonTemplate) types.GetAddonTemplateResponse {
	result := types.GetAddonTemplateResponse{
	...
	if addonTemplate.Status.HelmStatus.Values != "" || addonTemplate.Status.HelmStatus.ValuesYAML != "" {
		result.HelmStatus = &types.HelmStatusResponse{
