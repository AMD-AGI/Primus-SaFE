...
func TestCvtToAddonTemplateResponseItem(t *testing.T) {
	...
	tests := []struct {
		...
		validate func(*testing.T, types.AddonTemplateResponseItem)
	}{
		{
			...
			validate: func(t *testing.T, result types.AddonTemplateResponseItem) {
...
func TestCvtToGetAddonTemplateResponse(t *testing.T) {
	...
	tests := []struct {
		name     string
		template *v1.AddonTemplate
		validate func(*testing.T, types.GetAddonTemplateResponse)
	}{
		{
			...
			validate: func(t *testing.T, result types.GetAddonTemplateResponse) {
