...
func TestParseListPublicKeyQuery(t *testing.T) {
	...
	tests := []struct {
		name        string
		queryParams string
		validate    func(*testing.T, *types.ListPublicKeysRequest, error)
	}{
		{
			name:        "default values when no params",
			queryParams: "",
			validate: func(t *testing.T, query *types.ListPublicKeysRequest, err error) {
...
func TestSetPublicKeyStatusHandler(t *testing.T) {
	...
	t.Run("empty id returns error", func(t *testing.T) {
		...
		reqBody := types.SetPublicKeyStatusRequest{Status: true}
...
func TestSetPublicKeyDescriptionHandler(t *testing.T) {
	...
	t.Run("empty id returns error", func(t *testing.T) {
		...
		reqBody := types.SetPublicKeyDescriptionRequest{Description: "Test"}
		body, _ := json.Marshal(reqBody)
