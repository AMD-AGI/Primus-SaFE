...
func Test_generatePreheatWorkload(t *testing.T) {
	...
	mainQuery := &types.CreateWorkloadRequest{
...
func Test_listWorkload(t *testing.T) {
	...
	listResp, ok := result.(*types.ListWorkloadResponse)
...
func Test_getWorkload(t *testing.T) {
	...
	getResp, ok := result.(*types.GetWorkloadResponse)
	assert.Equal(t, ok, true)
...
func Test_patchWorkload(t *testing.T) {
	...
	newPriority := 1
	newImage := "new-image:v2"
	patchReq := types.PatchWorkloadRequest{
		Priority: &newPriority,
		Image:    &newImage,
	}
...
func Test_getWorkloadPodLog(t *testing.T) {
	...
	assert.NilError(t, err)
	podlog, ok := resp.(*types.GetWorkloadPodLogResponse)
	assert.Equal(t, ok, true)
...
func Test_getWorkloadPodContainers(t *testing.T) {
	...
	response, ok := result.(*types.GetWorkloadPodContainersResponse)
...
func Test_cloneWorkloadImpl(t *testing.T) {
	...
	cloneResp, ok := result.(*types.CreateWorkloadResponse)
...
func Test_createWorkload_NormalWorkload(t *testing.T) {
	...
	createResp, ok := result.(*types.CreateWorkloadResponse)
	assert.Equal(t, ok, true, "Result should be CreateWorkloadResponse")
