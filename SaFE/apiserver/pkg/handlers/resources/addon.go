...
func (h *Handler) createAddon(c *gin.Context) (interface{}, error) {
	...
	req := &view.CreateAddonRequestBody{}
...
func (h *Handler) generateAddon(c *gin.Context, req *view.CreateAddonRequestBody, body []byte) (*v1.Addon, error) {
...
func (h *Handler) getAddon(c *gin.Context) (interface{}, error) {
	addon, err := h.getAdminAddon(c.Request.Context(), c.Param(common.AddonName))
	if err != nil {
		return nil, err
	}
	return cvtToAddonResponseBody(addon), nil
...
func (h *Handler) deleteAddon(c *gin.Context) (interface{}, error) {
	ctx := c.Request.Context()
	addon, err := h.getAdminAddon(ctx, c.Param(common.AddonName))
	if err != nil {
...
func (h *Handler) updateAddon(addon *v1.Addon, req *view.PatchAddonRequest) bool {
	isChanged := false
...
func cvtToAddonResponseBody(addon *v1.Addon) view.AddonResponseBody {
	result := view.AddonResponseBody{
		Name:         addon.Name,
	...
	result.Description = v1.GetDescription(addon)
	...
	if addon.Spec.AddonSource.HelmRepository != nil {
		...
		result.ReleaseName = helmRepo.ReleaseName
	...
	if addon.Status.AddonSourceStatus.HelmRepositoryStatus != nil {
		...
		result.Status = view.AddonStatus{
