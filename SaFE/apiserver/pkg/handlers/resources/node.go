...
func (h *Handler) createNode(c *gin.Context) (interface{}, error) {
	...
	return &view.CreateNodeResponse{
		NodeId: node.Name,
	}, nil
}
...
func ExportNodeToCSV(nodes *view.ListNodeResponse, writer io.Writer) error {
...
func (h *Handler) ExportNodeByQuery(c *gin.Context) {
	...
	res, _ := result.(*view.ListNodeResponse) //Don't use brief, so struct is ListNodeResponse
...
func buildListNodeBriefResponse(totalCount int, nodes []*v1.Node) (interface{}, error) {
	result := &view.ListNodeBriefResponse{
...
func (h *Handler) listNodeRebootLog(c *gin.Context) (interface{}, error) {
	...
	req := &view.ListNodeRebootLogRequest{}
	...
	result := &view.ListNodeRebootLogResponse{
		TotalCount: count,
	}
	for _, job := range jobs {
		result.Items = append(result.Items, view.NodeRebootLogResponseItem{
...
func (h *Handler) getAllUsedResourcePerNode(ctx context.Context,
	query *view.ListNodeRequest) (map[string]*resourceInfo, error) {
...
func validateCreateNodeRequest(req *view.CreateNodeRequest) error {
	if req.FlavorId == "" {
...
func buildNodeLabelSelector(query *view.ListNodeRequest) (labels.Selector, error) {
...
func parseListNodeQuery(c *gin.Context) (*view.ListNodeRequest, error) {
...
func (h *Handler) applyNodePatch(ctx context.Context, node *v1.Node, req *view.PatchNodeRequest) (bool, error) {
	shouldUpdate := false
...
func generateNodeLabelAction(node *v1.Node, req *view.PatchNodeRequest) map[string]string {
...
func cvtToListNodeRebootSql(query *view.ListNodeRebootLogRequest, node *v1.Node) (sqrl.Sqlizer, []string) {
...
func generateWorkloadInfo(workload *v1.Workload) view.WorkloadInfo {
	return view.WorkloadInfo{
		Id:          workload.Name,
