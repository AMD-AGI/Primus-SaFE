...
func (h *Handler) createNodeTemplate(c *gin.Context) (interface{}, error) {
	...
	req := &view.CreateNodeTemplateRequest{}
	...
	return &view.CreateNodeTemplateResponse{
		Id: nt.Name,
	}, nil
}
...
func (h *Handler) listNodeTemplate(c *gin.Context) (interface{}, error) {
	...
	result := view.ListNodeTemplateResponse{}
	...
	for _, nt := range nts.Items {
		...
		result.Items = append(result.Items, view.NodeTemplateResponseItem{
			TemplateId:     nt.Name,
...
func generateNodeTemplate(c *gin.Context, req *view.CreateNodeTemplateRequest) *v1.NodeTemplate {
