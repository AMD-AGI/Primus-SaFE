...
func (h *Handler) createPublicKey(c *gin.Context) (interface{}, error) {
	...
	req := &view.CreatePublicKeyRequest{}
...
func (h *Handler) listPublicKeys(c *gin.Context) (interface{}, error) {
	...
	result := &view.ListPublicKeysResponse{
...
func (h *Handler) setPublicKeyStatus(c *gin.Context) (interface{}, error) {
	...
	req := &view.SetPublicKeyStatusRequest{}
	body, err := apiutils.ParseRequestBody(c.Request, req)
	if err != nil {
		klog.ErrorS(err, "fail to parse create public key request", "body", string(body))
		return nil, err
...
func (h *Handler) setPublicKeyDescription(c *gin.Context) (interface{}, error) {
	...
	req := &view.SetPublicKeyDescriptionRequest{}
	body, err := apiutils.ParseRequestBody(c.Request, req)
	if err != nil {
		klog.ErrorS(err, "fail to parse create public key request", "body", string(body))
		return nil, err
...
func cvtToPublicKeyResponse(k *dbclient.PublicKey) view.ListPublicKeysResponseItem {
	result := view.ListPublicKeysResponseItem{
		Id:          k.Id,
		UserId:      k.UserId,
...
func parseListPublicKeyQuery(c *gin.Context) (*view.ListPublicKeysRequest, error) {
...
func cvtToListPublicKeysSql(query *view.ListPublicKeysRequest) (sqrl.Sqlizer, []string, error) {
...
func buildListPublicKeysOrderBy(query *view.ListPublicKeysRequest, dbTags map[string]string) []string {
