...
func (h *Handler) createWorkspace(c *gin.Context) (interface{}, error) {
	...
	return &view.CreateWorkspaceResponse{
...
func (h *Handler) patchWorkspace(c *gin.Context) (interface{}, error) {
	...
	req := &view.PatchWorkspaceRequest{}
	body, err := apiutils.ParseRequestBody(c.Request, req)
	if err != nil {
...
func (h *Handler) applyWorkspacePatch(ctx context.Context,
	workspace *v1.Workspace, requestUser *v1.User, req *view.PatchWorkspaceRequest) error {
...
func (h *Handler) generateWorkspace(ctx context.Context,
	requestUser *v1.User, req *view.CreateWorkspaceRequest) (*v1.Workspace, error) {
	workspace := &v1.Workspace{
...
func parseListWorkspaceQuery(c *gin.Context) (*view.ListWorkspaceRequest, error) {
	query := &view.ListWorkspaceRequest{}
...
func buildListWorkspaceSelector(query *view.ListWorkspaceRequest) (labels.Selector, error) {
...
func (h *Handler) cvtToWorkspaceResponseItem(ctx context.Context, w *v1.Workspace) view.WorkspaceResponseItem {
	result := view.WorkspaceResponseItem{
		WorkspaceId:       w.Name,
	...
	for _, m := range w.Spec.Managers {
		...
		if err == nil {
			result.Managers = append(result.Managers, view.UserEntity{
