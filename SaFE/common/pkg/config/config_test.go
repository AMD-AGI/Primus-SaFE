...
func TestGettersWithValues(t *testing.T) {
	...
	viper.Set(cicdGithubProxyURL, "http://github-proxy:3128")
	viper.Set(cicdGithubProxyUser, "github")
	viper.Set(cicdGithubProxyNoProxy, "localhost,.svc")
	...
	testifyassert.Equal(t, "http://github-proxy:3128", GetCICDGithubProxyURL())
	testifyassert.Equal(t, "github", GetCICDGithubProxyUsername())
	testifyassert.Equal(t, "localhost,.svc", GetCICDGithubProxyNoProxy())
