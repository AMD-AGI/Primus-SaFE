...
func newImage(db *gorm.DB, opts ...gen.DOOption) image {
	...
	_image.Source = field.NewString(tableName, "source")
	_image.Status = field.NewString(tableName, "status")
	_image.RelationDigest = field.NewField(tableName, "relation_digest")
	_image.CreatedAt = field.NewTime(tableName, "created_at")
	_image.CreatedBy = field.NewString(tableName, "created_by")
	_image.UpdatedAt = field.NewTime(tableName, "updated_at")
	_image.DeletedAt = field.NewField(tableName, "deleted_at")
	_image.DeletedBy = field.NewString(tableName, "deleted_by")
...
func (i *image) updateTableName(table string) *image {
	...
	i.RelationDigest = field.NewField(table, "relation_digest")
...
func (i *image) fillFieldMap() {
	...
	i.fieldMap["relation_digest"] = i.RelationDigest
