...
The [upgrade.sh](https://github.com/AMD-AGI/Primus-SaFE/blob/main/bootstrap/upgrade.sh) script provides a mechanism to upgrade the Primus-SaFE system after the initial installation has been completed using [install.sh](https://github.com/AMD-AGI/Primus-SaFE/blob/main/bootstrap/install.sh).

### 📋 Prerequisites

Before running the upgrade script, ensure that:

1. [install.sh](https://github.com/AMD-AGI/Primus-SaFE/blob/main/bootstrap/install.sh) has been executed successfully
...
```bash
docker buildx build . -t your-image-registry/primussafe/resource-manager:version -f ./resource-manager/installer/Dockerfile --push
```
...
Before running the upgrade, manually update the image versions in [charts/primus-safe/values.yaml](https://github.com/AMD-AGI/Primus-SaFE/blob/main/charts/primus-safe/values.yaml):
...
Unlike [install.sh](https://github.com/AMD-AGI/Primus-SaFE/blob/main/bootstrap/install.sh), the upgrade script:
...
- Manual updates to [charts/primus-safe/values.yaml](https://github.com/AMD-AGI/Primus-SaFE/blob/main/charts/primus-safe/values.yaml) are required for image version changes
