module github.com/AMD-AIG-AIMA/SAFE/resource-manager
...
require (
	...
	github.com/moby/moby/v2 v2.0.0-beta.12 // indirect
...
replace (
	...
	oras.land/oras-go => oras.land/oras-go v1.2.8-0.20260512121625-0de7d606092e
)
