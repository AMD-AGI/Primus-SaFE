<template>
  ...
  <el-tabs v-model="activeTab" class="mt-4">
    ...
    <el-tab-pane label="Pods" name="pods">
      <WorkloadPodsTable
        ...
        :nodes-history="workloadDetail?.nodesHistory"
  ...
  <AddDialog
    ...
    action="Clone"
    @success="() => router.push('/preflight/ws')"
  />
  <SshConfigDialog
...
const {
  ...
  redirectPath: '/preflight/ws',
  overrideWorkspaceId: () => preflightDetail.value?.workspaceId,
})
