...
func (b *WorkspaceApplyConfiguration) WithCreationTimestamp(value apismetav1.Time) *WorkspaceApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *WorkspaceApplyConfiguration) WithDeletionTimestamp(value apismetav1.Time) *WorkspaceApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *WorkspaceApplyConfiguration) WithOwnerReferences(values ...*metav1.OwnerReferenceApplyConfiguration) *WorkspaceApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
	for i := range values {
		if values[i] == nil {
