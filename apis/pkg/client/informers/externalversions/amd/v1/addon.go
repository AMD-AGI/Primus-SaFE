	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.AmdV1().Addons(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AmdV1().Addons(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options metav1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AmdV1().Addons(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AmdV1().Addons(namespace).Watch(ctx, options)
			},
		},
		&apisamdv1.Addon{},
		resyncPeriod,
...
func (f *addonInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisamdv1.Addon{}, f.defaultInformer)
}

func (f *addonInformer) Lister() amdv1.AddonLister {
	return amdv1.NewAddonLister(f.Informer().GetIndexer())
}
