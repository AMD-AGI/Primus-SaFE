#!/bin/bash
# OCI Test: 多机全量 SFT (8B, 8 GPU × 2 nodes)
set -euo pipefail
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
JOB_NAME="oci-test-multi-full-$(date +%s)"
echo "========== OCI Test: Multi-Node Full SFT =========="
echo "Job: $JOB_NAME"
...
mkdir -p "./output/${PRIMUS_TEAM:-amd}/${PRIMUS_USER:-root}/oci-test-multi-full"
